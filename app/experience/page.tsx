  ...
  return (
    <section className="w-full min-h-screen bg-[#080808] text-zinc-100 py-32 px-4 md:px-12 lg:px-20 font-mono">
      ...
      <div className="max-w-[1600px] mx-auto space-y-32">
          ...
          <div key={job.id} className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-zinc-900 border border-zinc-900 overflow-hidden rounded-sm group">
            ...
            <div className="lg:col-span-9 bg-[#0c0c0c] p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12">
                {Object.entries(job.layers).map(([title, points], i) => (
        ...
        {/* 03. FOOTER NODES (TCS & WE DATA) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-900 border border-zinc-900">
          {[
            { 
              org: "TCS iON", 
              role: "ML Intern", 
              bullets: ["Evaluated models via ROC-AUC & Confusion Matrix.", "Built supervised/unsupervised ensembles (Random Forest, K-Means).", "Documented ML pipelines for technical stakeholders."]
            },
            { 
              org: "We & Data", 
              role: "BI & Data Analytics", 
              bullets: ["Designed interactive dashboards (Power BI/Tableau/Looker).", "Optimized SQL queries & ETL workflows for cloud storage.", "Automated recurring KPI reporting for business stakeholders."]
            }
          ].map((mini, i) => (
